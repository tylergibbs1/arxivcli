const SCHEMAS: Record<string, object> = {
  search: {
    ...
    args: {
      ...
      "--max": { type: "integer", default: 10, description: "Max results" },
      "--start": { type: "integer", default: 0, description: "Pagination start index" },
      ...
      "--category": { type: "string", description: "Category filter (e.g. cs.AI)" },
      "--type": { type: "enum", values: ["all", "title", "author", "abstract"], default: "all", description: "Search field (scrape only)" },
  ...
  download: {
    ...
    args: {
      ...
      "--output": { type: "string", description: "Output path (default <id>.pdf)" },
